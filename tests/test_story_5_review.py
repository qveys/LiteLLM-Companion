...
class TestStory5DeepDiveReview:
    ...
    def test_has_tables(self, deep_dive_content):
        ...
        assert "| Shell | Format | Exemple | Défis |" in deep_dive_content, "Should have shell format table"
    ...
    def test_double_scan_problem(self, deep_dive_content):
        ...
        scan_section = deep_dive_content[deep_dive_content.find("Double Scan des Processus"):
                                       deep_dive_content.find("Double Scan des Processus") + 500]
        
        assert "psutil.process_iter()" in scan_section, "Should show the redundant process iteration"
    ...
    def test_cpu_precision_problem(self, deep_dive_content):
        ...
        cpu_section = deep_dive_content[deep_dive_content.find("Précision du CPU sur Premier Appel"):
                                        deep_dive_content.find("Précision du CPU sur Premier Appel") + 500]
    ...
    def test_persistence_problem(self, deep_dive_content):
        ...
        persistence_section = deep_dive_content[deep_dive_content.find("Format de Persistance Fragile"):
                                               deep_dive_content.find("Format de Persistance Fragile") + 500]
    ...
    def test_wsl_testing_problem(self, deep_dive_content):
        ...
        wsl_section = deep_dive_content[deep_dive_content.find("Détection WSL Non Testée"):
                                       deep_dive_content.find("Détection WSL Non Testée") + 500]
        
        assert "Code win32 non testé" in wsl_section, "Should mention untested code"
        assert "Fiabilité inconnue sur Windows" in wsl_section, "Should explain the reliability concern"
    ...
    def test_process_detection_algorithm(self, deep_dive_content):
        ...
        detection_section = deep_dive_content[deep_dive_content.find("Détection des Processus CLI"):
                                             deep_dive_content.find("Analyse de l'Historique Shell")]
    ...
    def test_shell_format_table(self, deep_dive_content):
        ...
        shell_table = deep_dive_content[deep_dive_content.find("| Shell | Format | Exemple | Défis |"):
                                       deep_dive_content.find("| Shell | Format | Exemple | Défis |") + 500]
    ...
    def test_wsl_implementation(self, deep_dive_content):
        ...
        wsl_section = deep_dive_content[deep_dive_content.find("Détection WSL"):
    ...
    def test_shared_snapshot_implementation(self, deep_dive_content):
        ...
        annexes_section = deep_dive_content[deep_dive_content.find("Implémentation du Snapshot Partagé"):
                                           deep_dive_content.find("Implémentation de la Persistance Robuste")]
    ...
    def test_robust_persistence_implementation(self, deep_dive_content):
        ...
        persistence_section = deep_dive_content[deep_dive_content.find("Implémentation de la Persistance Robuste"):
    ...
    def test_robust_process_detection_implementation(self, deep_dive_content):
        ...
        detection_section = deep_dive_content[deep_dive_content.find("Implémentation de la Détection Robuste des Processus"):]
        
        assert "class CLIDetector:" in detection_section
        assert "self._process_cache = {}  # pid -> process_info" in detection_section
        assert "def _get_process_info(self, proc: psutil.Process) -> dict | None:" in detection_section
    ...
    def test_recommendations_have_timelines(self, deep_dive_content):
        ...
        assert "Snapshot partagé + tests Windows" in semaine_1_content, "Week 1 should focus on shared snapshot and Windows tests"
        assert "critique pour la fiabilité" in semaine_1_content, "Week 1 should mention reliability"
