...
class TestStory4DeepDiveReview:
    ...
    def test_has_tables(self, deep_dive_content):
        ...
        assert "| Navigateur | Époque | Unité |" in deep_dive_content, (
            "Should have timestamp epoch table"
        )
        assert "| Métrique | Cible Actuelle | Cible Améliorée |" in deep_dive_content, (
    ...
    def test_unnecessary_copy_problem(self, deep_dive_content):
        ...
        copy_section = deep_dive_content[
            deep_dive_content.find("Problème de Copie Innécessaire") : deep_dive_content.find(
                "Problème de Copie Innécessaire"
            )
            + 500
        ]
    ...
    def test_path_cache_problem(self, deep_dive_content):
        ...
        cache_section = deep_dive_content[
            deep_dive_content.find("Pas de Cache des Chemins") : deep_dive_content.find(
                "Pas de Cache des Chemins"
            )
            + 500
        ]
    ...
    def test_error_handling_problem(self, deep_dive_content):
        ...
        error_section = deep_dive_content[
            deep_dive_content.find("Gestion des Erreurs Limitée") : deep_dive_content.find(
                "Gestion des Erreurs Limitée"
            )
            + 500
        ]
    ...
    def test_timestamp_epoch_table(self, deep_dive_content):
        ...
        epoch_table = deep_dive_content[
            deep_dive_content.find("| Navigateur | Époque |") : deep_dive_content.find(
                "| Navigateur | Époque |"
            )
            + 300
        ]
    ...
    def test_timestamp_conversion_problems(self, deep_dive_content):
        ...
        timestamp_section = deep_dive_content[
            deep_dive_content.find("Gestion des Époques de Temps") : deep_dive_content.find(
                "Estimation des Sessions"
            )
        ]
    ...
    def test_session_estimation_algorithm(self, deep_dive_content):
        ...
        session_section = deep_dive_content[
            deep_dive_content.find("Estimation des Sessions") : deep_dive_content.find(
                "Requêtes SQLite et Performance"
            )
        ]
    ...
    def test_sqlite_query_analysis(self, deep_dive_content):
        ...
        sqlite_section = deep_dive_content[
            deep_dive_content.find("Requêtes SQLite et Performance") : deep_dive_content.find(
                "Tests de Validation Proposés"
            )
        ]
    ...
    def test_path_cache_implementation(self, deep_dive_content):
        ...
        annexes_section = deep_dive_content[
            deep_dive_content.find("Implémentation du Cache des Chemins") : deep_dive_content.find(
    ...
    def test_timestamp_normalization_implementation(self, deep_dive_content):
        ...
        normalization_section = deep_dive_content[
            deep_dive_content.find("Implémentation de la Normalisation Centrale") :
        ]

        assert (
            "def _normalize_timestamp(self, ts: int, browser: str) -> float:"
            in normalization_section
        )
        assert (
            "def _query_sqlite(self, db_path: Path, query: str, params: tuple, browser: str)"
            in normalization_section
        )
        assert (
    ...
    def test_recommendations_have_timelines(self, deep_dive_content):
        ...
        assert "optimisation des copies" in semaine_1_content, (
            "Week 1 should focus on copy optimization"
        )
